<?php
/**
 * Build lmft-clinical-form-b-answer-key-26-50.php from embedded PROMPT 20 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-answer-key-26-50.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-admin-prompt-20.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-admin-prompt-20.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * ADMIN ONLY — LMFT California Clinical Form B answer key items 26–50 (PROMPT 20).\n";
...
$target = $root . '/includes/quiz-seeds/admin-only/lmft-clinical-form-b-answer-key-26-50.php';
