<?php
/**
 * Build lmft-clinical-form-a-items-101-125.php from embedded PROMPT 05 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-a-items-101-125.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-a-prompt-05.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-a-prompt-05.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form A items 101–125 (PROMPT 05).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-a-items-101-125.php';
