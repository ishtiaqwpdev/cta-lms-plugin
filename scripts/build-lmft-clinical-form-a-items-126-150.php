<?php
/**
 * Build lmft-clinical-form-a-items-126-150.php from embedded PROMPT 06 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-a-items-126-150.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-a-prompt-06.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-a-prompt-06.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form A items 126–150 (PROMPT 06).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-a-items-126-150.php';
