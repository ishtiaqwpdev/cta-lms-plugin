<?php
/**
 * Build lmft-clinical-form-a-items-76-100.php from embedded PROMPT 04 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-a-items-76-100.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-a-prompt-04.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-a-prompt-04.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form A items 76–100 (PROMPT 04).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-a-items-76-100.php';
