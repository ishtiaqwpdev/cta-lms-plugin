<?php
/**
 * Build lmft-clinical-form-b-items-126-150.php from embedded PROMPT 12 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-items-126-150.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-prompt-12.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-prompt-12.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form B items 126–150 (PROMPT 12).\n";
...
foreach ( $data['questions'] as $row ) {
	...
	$out .= "\tarray(\n";
	$out .= "\t\t'question_code'  => 'CTA-LMFT-CA-FB-" . str_pad( (string) $num, 3, '0', STR_PAD_LEFT ) . "',\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-b-items-126-150.php';
