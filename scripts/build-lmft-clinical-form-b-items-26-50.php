<?php
/**
 * Build lmft-clinical-form-b-items-26-50.php from embedded PROMPT 08 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-items-26-50.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-prompt-08.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-prompt-08.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form B items 26–50 (PROMPT 08).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-b-items-26-50.php';
