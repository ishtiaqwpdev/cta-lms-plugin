<?php
/**
 * Build lmft-clinical-form-b-items-01-25.php from embedded PROMPT 07 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-items-01-25.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-prompt-07.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-prompt-07.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form B items 1–25 (PROMPT 07).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-b-items-01-25.php';
