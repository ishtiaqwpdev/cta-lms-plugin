<?php
/**
 * Build lmft-clinical-form-b-items-101-125.php from embedded PROMPT 11 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-items-101-125.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-prompt-11.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-prompt-11.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form B items 101–125 (PROMPT 11).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-b-items-101-125.php';
