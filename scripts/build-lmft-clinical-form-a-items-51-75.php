<?php
/**
 * Build lmft-clinical-form-a-items-51-75.php from embedded PROMPT 03 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-a-items-51-75.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-a-prompt-03.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-a-prompt-03.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form A items 51–75 (PROMPT 03).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-a-items-51-75.php';
