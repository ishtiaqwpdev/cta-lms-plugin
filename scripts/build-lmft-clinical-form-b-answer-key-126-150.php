<?php
/**
 * Build lmft-clinical-form-b-answer-key-126-150.php from embedded PROMPT 24 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-answer-key-126-150.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-admin-prompt-24.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-admin-prompt-24.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * ADMIN ONLY — LMFT California Clinical Form B answer key items 126–150 (PROMPT 24).\n";
...
$target = $root . '/includes/quiz-seeds/admin-only/lmft-clinical-form-b-answer-key-126-150.php';
