<?php
/**
 * Build lmft-clinical-form-a-answer-key-51-75.php from embedded PROMPT 15 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-a-answer-key-51-75.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-a-admin-prompt-15.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-a-admin-prompt-15.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * ADMIN ONLY — LMFT California Clinical Form A answer key items 51–75 (PROMPT 15).\n";
...
$target = $root . '/includes/quiz-seeds/admin-only/lmft-clinical-form-a-answer-key-51-75.php';
