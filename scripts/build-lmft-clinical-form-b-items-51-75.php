<?php
/**
 * Build lmft-clinical-form-b-items-51-75.php from embedded PROMPT 09 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-items-51-75.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-prompt-09.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-prompt-09.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form B items 51–75 (PROMPT 09).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-b-items-51-75.php';
