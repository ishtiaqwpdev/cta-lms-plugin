<?php
/**
 * Extract paragraph text from Form A v2.0 controlled answer-key document.xml.
 * CLI only. Writes local tmp paras for admin parse — never a learner route.
 *
 * Usage: php scripts/_extract_lpcc_form_a_v2_key_paras.php
 */
...
$xml_path = dirname( __DIR__ ) . '/_tmp_lpcc_form_a_v2_key/unzip/word/document.xml';
...
$dump = dirname( __DIR__ ) . '/_tmp_lpcc_form_a_v2_key/paras.txt';
