<?php
/**
 * Build lmft-clinical-form-b-items-76-100.php from embedded PROMPT 10 JSON.
 *
 * Usage: php scripts/build-lmft-clinical-form-b-items-76-100.php
 *
 * @package CTA_LMS
 */

$root = dirname( __DIR__ );
$json = file_get_contents( __DIR__ . '/_lmft-form-b-prompt-10.json' );
if ( false === $json ) {
	fwrite( STDERR, "Missing scripts/_lmft-form-b-prompt-10.json\n" );
	exit( 1 );
}
...
$out = "<?php\n";
$out .= "/**\n";
$out .= " * LMFT California Clinical — Comprehensive Simulation Form B items 76–100 (PROMPT 10).\n";
...
$target = $root . '/includes/quiz-seeds/lmft-clinical-form-b-items-76-100.php';
